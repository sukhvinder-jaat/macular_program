      ...
      <Container className="container">
        <div className="z_index_10">
          <button
            ...
            className={
              first
                ? "d-none end-0 bottom-0 me-5 mb-5 back_top_btn bg-transparent border-0 position-fixed"
                : "d-block end-0 bottom-0 me-5 mb-5 back_top_btn bg-transparent border-0 position-fixed"
            }
          >
            <svg
              className=""
